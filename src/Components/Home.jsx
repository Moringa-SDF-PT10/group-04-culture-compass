          ...
          <div className="home">
            ...
            <div className="features">
              <div className="feature">
                <div className="icon"><img src='/src/assets/diversity.png'/></div>
              ...
              <div className="feature">
                <div className="icon"><img src='/src/assets/cuisine.png'/></div>
              ...
              <div className="feature">
                <div className="icon"><img src='/src/assets/booking.png'/></div>
